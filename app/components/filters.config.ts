...
export const filtersConfig: FiltersConfig = {
  ...
  sale: [
    { key: "price", label: "Ціна", type: "range", section: "main" },
    { key: "area", label: "Площа", type: "range", section: "main" },
    { key: "yearBuilt", label: "Рік будівництва", type: "range", section: "building" },
    { key: "heating", label: "Опалення", type: "multi_select", section: "building", hiddenInTop: true },
    { key: "renovation", label: "Стан", type: "multi_select", section: "comfort", hiddenInTop: true },
    { key: "parking", label: "Паркінг", type: "multi_select", section: "comfort", hiddenInTop: true },
    { key: "documentsReady", label: "Документи", type: "toggle", section: "legal", hiddenInTop: true },
  ],
  rent: [
    { key: "price", label: "Ціна", type: "range", section: "main" },
    { key: "area", label: "Площа", type: "range", section: "main" },
    { key: "furnished", label: "Меблі", type: "toggle", section: "comfort" },
    { key: "yearBuilt", label: "Рік будівництва", type: "range", section: "building", hiddenInTop: true },
    { key: "heating", label: "Опалення", type: "multi_select", section: "building", hiddenInTop: true },
    { key: "renovation", label: "Стан", type: "multi_select", section: "comfort", hiddenInTop: true },
    { key: "parking", label: "Паркінг", type: "multi_select", section: "comfort", hiddenInTop: true },
  ],
